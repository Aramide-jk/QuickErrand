  ...
  const initialMessages = [
    {
      id: 1,
      sender: "runner",
      text: "Hi! I'm aramide, your runner for today. I'm heading to Shoprite now to get your items.",
      timestamp: "10:30 AM",
      type: "text",
    },
    {
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-full focus:outline-0 focus:ring-1 focus:ring-green-700 focus:border-transparent"
